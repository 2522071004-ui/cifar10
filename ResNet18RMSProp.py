...
writer = SummaryWriter(log_dir='logs/RMSProp')
...
for epoch in tqdm(range(1, n_epochs + 1)):
    ...
    if counter / 10 == 1:
        counter = 0
        lr = lr * 0.5
    optimizer = optim.RMSprop(model.parameters(), lr=lr, alpha=0.99, eps=1e-08, momentum=0.9)
    ###################
    # 训练集的模型 #
    ###################
    ...
    if valid_loss <= valid_loss_min:
        ...
        torch.save(model.state_dict(), 'model/resnet18_cifar10RMSProp.pt')
